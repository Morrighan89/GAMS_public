"""
GRE sequence (template used for the generation of PD-weighted image in Sub-section 4.2 of https://dx.doi.org/10.2139/ssrn.4882851)
---
...
rf, gz, gzr = make_sinc_pulse(flip_angle=flip_ang, system=system, duration=1.5e-3,
slice_thickness=slice_thickness, apodization=apodization, return_gz=True, time_bw_product=4)
""" READOUT 
...
delay_TE = TE - calc_duration(gx_pre) - gz.fall_time - gz.flat_time / 2 - calc_duration(gx) / 2
delay_TR = TR - calc_duration(gz) - calc_duration(gx_pre) - calc_duration(gx) - delay_TE
...
""" GENERATING `.SEQ` FILE 
Uncomment the code in the cell below to generate a `.seq`.
"""
