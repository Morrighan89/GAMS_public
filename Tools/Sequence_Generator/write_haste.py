...
system = Opts(max_grad=30, grad_unit='mT/m', max_slew=170, slew_unit='T/m/s', rf_ringdown_time=100e-6,
              rf_dead_time=100e-6, adc_dead_time=10e-6,grad_raster_time=10.e-6,rf_raster_time=1.e-6)
...
GS1 = make_extended_trapezoid(channel='z', system=system, times=GS1_times, amplitudes=GS1_amp)

GS2_times = [0, GS_ex.flat_time]
GS2_amp = [GS_ex.amplitude, GS_ex.amplitude]
GS2 = make_extended_trapezoid(channel='z', system=system, times=GS2_times, amplitudes=GS2_amp)
...
GS3 = make_extended_trapezoid(channel='z', system=system, times=GS3_times, amplitudes=GS3_amp)

GS4_times = [0, GS_ref.flat_time]
GS4_amp = [GS_ref.amplitude, GS_ref.amplitude]
GS4 = make_extended_trapezoid(channel='z', system=system, times=GS4_times, amplitudes=GS4_amp)
...
GS5 = make_extended_trapezoid(channel='z', system=system, times=GS5_times, amplitudes=GS5_amp)
...
GS7 = make_extended_trapezoid(channel='z', system=system, times=GS7_times, amplitudes=GS7_amp)
...
GR5 = make_extended_trapezoid(channel='x', system=system, times=GR5_times, amplitudes=GR5_amp)

GR6_times = [0, readout_time]
GR6_amp = [GR_acq.amplitude, GR_acq.amplitude]
GR6 = make_extended_trapezoid(channel='x', system=system, times=GR6_times, amplitudes=GR6_amp)
...
GR7 = make_extended_trapezoid(channel='x', system=system, times=GR7_times, amplitudes=GR7_amp)
